...
function Contacto() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const response = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].CONTACTO, {
                method: 'POST',
                headers: {
